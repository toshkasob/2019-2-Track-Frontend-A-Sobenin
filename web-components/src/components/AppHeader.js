...
template.innerHTML = `
    ...
    <button class="button-back">
        <svg id="button-back_img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="50px" height="50px" viewBox="0 0 408 408" xml:space="preserve">
    ...
    <button class="button-search">
        <svg id="button-search_img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <svg id="button-settings_img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
